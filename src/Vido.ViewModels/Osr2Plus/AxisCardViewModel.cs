...
public class AxisCardViewModel : INotifyPropertyChanged
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AxisCardViewModel"/> class.
    /// </summary>
    /// <param name="config">The axis configuration backing this card.</param>
    /// <param name="tcode">The TCode service for sending position commands.</param>
