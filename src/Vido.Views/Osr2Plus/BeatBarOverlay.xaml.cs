...
public partial class BeatBarOverlay : UserControl
{
    ...
    /// <summary>Initializes a new instance of the <see cref="BeatBarOverlay"/> class.</summary>
    ...
    /// </summary>
    private Border? FindControlsOverlay()
    {
    ...
    private void AdjustFullscreenMargin()
    {
        ...
        double target = Grid.GetRow(_controlsOverlay) == 0
