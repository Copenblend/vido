...
public sealed class UpdateCheckResult
{
    ...
    /// <summary>The latest available version string from the remote source.</summary>
    public string LatestVersion { get; init; } = string.Empty;

    /// <summary>URL to the release page (for manual download).</summary>
    public string? ReleaseUrl { get; init; }

    /// <summary>Release notes / changelog body.</summary>
    public string? ReleaseNotes { get; init; }

    /// <summary>Direct download URL for the installer asset (.msi).</summary>
