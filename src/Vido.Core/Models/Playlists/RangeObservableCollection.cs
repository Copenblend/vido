...
/// <summary>
/// An <see cref="ObservableCollection{T}"/> that supports efficient bulk operations.
/// Bulk methods (<see cref="AddRange"/>, <see cref="RemoveRange"/>, <see cref="ReplaceAll"/>)
/// suppress per-item change notifications and emit a single <see cref="NotifyCollectionChangedAction.Reset"/>
/// notification at the end, avoiding excessive UI updates.
/// </summary>
...
public class RangeObservableCollection<T> : ObservableCollection<T>
{
    ...
    /// </summary>
    /// <param name="predicate">Predicate used to select items to remove. Must not be <c>null</c>.</param>
    ...
    /// </summary>
    /// <param name="items">The new collection contents. Must not be <c>null</c>.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="items"/> is <c>null</c>.</exception>
    ...
    /// <summary>
    /// Raises a <see cref="NotifyCollectionChangedAction.Reset"/> notification
    /// along with <see cref="INotifyPropertyChanged"/> notifications for
    /// <c>Count</c> and <c>Item[]</c>.
    /// </summary>
