...
internal sealed class PulseEngine : IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the Pulse engine.
    /// </summary>
    ...
    /// </summary>
    /// <param name="enabled">Whether to enable or disable Pulse.</param>
    ...
    /// </summary>
    /// <param name="args">Audio sample event args from the video engine.</param>
