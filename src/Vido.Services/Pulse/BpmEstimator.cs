...
internal sealed class BpmEstimator
{
    ...
    /// </summary>
    /// <param name="beat">The detected beat event to add.</param>
    ...
    /// </summary>
    /// <param name="rawTimestampMs">The raw beat timestamp in milliseconds.</param>
    /// <returns>The quantized timestamp, or the original if confidence is too low.</returns>
