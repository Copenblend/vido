...
internal sealed class AudioPreAnalysisService : IDisposable
{
    ...
    /// </summary>
    /// <param name="mediaPath">Path to the media file to analyze.</param>
    /// <param name="cancellationToken">Optional cancellation token.</param>
    /// <returns>A task representing the analysis operation.</returns>
    /// <exception cref="ArgumentException">Thrown when <paramref name="mediaPath"/> is null or empty.</exception>
    ...
    /// <param name="sensitivity">New sensitivity multiplier.</param>
