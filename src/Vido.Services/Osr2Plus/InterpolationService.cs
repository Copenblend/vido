...
public class InterpolationService
{
    ...
    /// <summary>
    /// Finds the index of the action just before <paramref name="timeMs"/>.
    /// First tries to advance from <paramref name="lastIndex"/> (O(1) for sequential playback),
    ...
    /// <summary>
    /// Resets all cached indices. Call after script load or seek to ensure
