...
/// Time-based patterns take a normalized time parameter <paramref name="t"/> (0.0–1.0, wrapping)
/// and return a position value (0.0–1.0).
/// All waveforms use smooth cosine transitions at direction changes to avoid
/// instantaneous direction reversals that could harm physical actuators.
/// </summary>
