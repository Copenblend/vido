...
public class FunscriptLoadingService
{
    ...
    /// <summary>
    /// Currently loaded scripts per axis (axisId → <see cref="FunscriptData"/>).
    /// </summary>
    ...
    /// <summary>
    /// Gets the video path that scripts are currently loaded for.
    /// </summary>
    public string? CurrentVideoPath { get; private set; }

    /// <summary>
    /// Fired when the loaded scripts change (load, unload, or override).
    /// The dictionary maps axisId → <see cref="FunscriptData"/> for all loaded axes.
    /// </summary>
    public event Action<IReadOnlyDictionary<string, FunscriptData>>? ScriptsChanged;

    /// <summary>
    /// Initializes a new instance of the <see cref="FunscriptLoadingService"/> class.
    /// </summary>
    /// <param name="parser">Parser for reading funscript JSON files.</param>
    /// <param name="matcher">Matcher for finding funscript files by naming convention.</param>
    ...
    /// <summary>
    /// Gets the currently loaded scripts (axisId → <see cref="FunscriptData"/>).
    /// </summary>
    ...
    /// </summary>
    /// <returns>List of log messages describing what was cleared.</returns>
    ...
    /// until explicitly cleared. If a video is currently loaded, the override
    ...
    /// <summary>
    /// Gets a value indicating whether any manual overrides are set.
    /// </summary>
